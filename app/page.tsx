            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="space-y-4">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Take control of your finances with Finance Buddy
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Track expenses, plan budgets, and visualize your financial journey with our comprehensive financial
                  management tool.
                </p>
                ...
                <div className="relative w-full max-w-[500px] aspect-video overflow-hidden rounded-xl border bg-muted/50 shadow-xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center">
                    <div className="grid grid-cols-2 gap-4 p-6">
                      <div className="col-span-2 h-24 rounded-lg bg-white/90 shadow-sm p-4">
                        <div className="text-sm font-medium text-gray-500">Total Balance</div>
                        <div className="text-2xl font-bold text-gray-900">$12,750.00</div>
                        <div className="text-xs text-green-500 mt-1">↑ 12% from last month</div>
                      </div>
                      <div className="h-20 rounded-lg bg-white/90 shadow-sm p-4">
                        <div className="text-sm font-medium text-gray-500">Income</div>
                        <div className="text-xl font-bold text-gray-900">$4,250.00</div>
                      </div>
                      <div className="h-20 rounded-lg bg-white/90 shadow-sm p-4">
                        <div className="text-sm font-medium text-gray-500">Expenses</div>
                        <div className="text-xl font-bold text-gray-900">$2,150.00</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <p className="text-center text-sm text-gray-500">
                  Create and manage budgets for different categories to help you stay on track with your financial
                  goals.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <p className="text-center text-sm text-gray-500">
                  Visualize your spending patterns and financial progress with interactive charts and reports.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-16 md:flex-row">
          <p className="text-center text-sm leading-loose text-gray-500 md:text-left">
            © 2024 Finance Buddy. All rights reserved.
          </p>
